...
[![AUR git package](https://img.shields.io/aur/version/prismatik-psieg-git?logo=arch-linux&label=aur-git&labelColor=lightGrey&color=grey)](https://aur.archlinux.org/packages/prismatik-psieg-git/)
